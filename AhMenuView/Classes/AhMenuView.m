...
#define K_BoomBackColor AHColor(223, 223, 223) // 滚动条的背景色
#define K_NormalColor   AHColor(56, 44, 36)    // button正常时的颜色
#define K_selColor      AHColor(62, 203, 213)  // button选中时的颜色
...
//        MYLog(@"按钮的frame:%d====%@",i,NSStringFromCGRect(btn.frame));
        ...
        if (i==0) {  //  设置初始状态
            ...
            self.BoomLine.backgroundColor = K_selColor;
            if (_block) {  // block块
                _block(vc,0);
            }
        }
